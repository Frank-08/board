...
CREATE TABLE IF NOT EXISTS resolutions (
    ...
    casting_vote_used BOOLEAN DEFAULT FALSE,
    referral_body VARCHAR(255) DEFAULT NULL,
    referral_scope TEXT DEFAULT NULL,
    clerk_notes TEXT DEFAULT NULL,
...
-- Table for procedural proposals log
