...
<body>
    <div class="header">
        <?php if (defined('LOGO_URL') && LOGO_URL && file_exists(__DIR__ . '/../' . LOGO_URL)): ?>
            <img src="<?php echo '../' . LOGO_URL; ?>" alt="<?php echo APP_NAME; ?> Logo" style="max-width: <?php echo defined('LOGO_WIDTH_HTML') ? LOGO_WIDTH : 60; ?>px; height:<?php echo defined('LOGO_HEIGHT') && LOGO_HEIGHT > 0 ? LOGO_HEIGHT : 'auto'; ?>px; max-height:80px; margin-bottom: 10px;">
        <?php endif; ?>
